...
const ChartToolbar = (props) => {
  ...
  return (
    <Toolbar className={classes.root}>
      ...
      >
        <RegionDropDown regionName={region} handleChange={toggleRegion} />

        <YearDropDown year={year} handleChange={toggleYear} />
...
ChartToolbar.propTypes = {
  ...
  toggleMeasurement: PropTypes.func.isRequired,
};
...
export default function RegionChart(props) {
  ...
  const [measurement, setmeasurement] = useState("measurementA");
